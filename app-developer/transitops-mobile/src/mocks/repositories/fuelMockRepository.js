...
export const fuelMockRepository = {
  async list(query = {}) {
    ...
    return paginateItems(
      items.map((item) => enrichFuelLog(item)),
      query,
    )
  },
  ...
  async create(payload) {
    ...
    await persistDb()
    return singleResponse(enrichFuelLog(record), 'Fuel log created successfully.')
  },
  ...
  async remove(id) {
    ...
    await persistDb()
    return singleResponse(enrichFuelLog(removed), 'Fuel log deleted successfully.')
  },
}
